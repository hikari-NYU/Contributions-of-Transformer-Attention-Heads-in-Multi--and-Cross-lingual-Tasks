...
class DataTrainingArguments:
    ...
    source_labels: Optional[str] = field(
        default=None,
...
def main():
    ...
    # torch.cuda.set_device(int(data_args.devices))  # default single gpu
    # print("use cuda:",int(data_args.devices))
    # exit()
    ...
    source_labels = token_classification_task.get_labels(data_args.source_labels)
    labels = token_classification_task.get_labels(data_args.labels)
    labels = list(set(source_labels + labels))
